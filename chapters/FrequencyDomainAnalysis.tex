...
\begin{figure}
	...
	\caption{Bode diagram of the second disk subject to an unbalance at the second disk. Amplitudes of $ \mathbf{v\ \&\ w} $ are identical for this asymmetric system, phase of $ \mathbf{w} $ would be lagging $ \mathbf{v} $ by $ \mathbf{90[deg]} $.}
