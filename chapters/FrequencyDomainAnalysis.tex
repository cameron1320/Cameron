...
\begin{figure}
	...
	\pgfplotsset{
		every picture/.style={trim axis left,trim axis right},
					every axis/.style={
			zlabel style={yshift=-.5cm},
			 zticklabel style={rotate=90},
		},
	}
	\centering
...
\begin{figure}
	...
	\caption{Nyquist Diagram for the first mode at node 6 in the whirl speed range $ 1100 < \omega < 1300[RPM] $ at a spin speed, $ \Omega=4000[RPM] $}
\end{figure}
